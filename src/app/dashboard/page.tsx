        ...
        <>
                ...
                <div className="w-full">
                    ...
                    <div className="flex sm:flex-nowrap flex-wrap py-8 gap-8">
                        <div className="flex flex-col gap-8 p-5 sm:w-[50%] w-full bg-red-600 text-tertiary backdrop-blur-sm bg-cover rounded-[15px]">
                        ...
                        <div className="flex flex-col gap-8 p-5 sm:w-[50%] w-full bg-tertiary text-black bg-cover rounded-[15px]">
