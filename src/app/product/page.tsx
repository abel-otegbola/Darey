...
export default function Product() {
    ...
    return (
        <div className="md:px-[8%] px-4 md:py-[50px] py-[20px]">
                ...
                <h2 className="md:text-[64px] text-[32px] font-bold py-6 uppercase">Related Products</h2>
                <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 sm:gap-4 gap-2 pb-[40px] ">
                    {
